...
!(function (t, n) {
    ...
    q = (function (t) {
      ...
      return (
        (i.onError = function (n, i, r) {
          return (
            t.prototype.emitReserved.call(this, 'error', new V(n, i, r)),
            this
          );
        }),
        (i.open = function () {
      ...
      return (
        (i.A = function () {
          ...
          try {
            ...
            (null === (t = this.l.cookieJar) || void 0 === t || t.addCookies(e),
      ...
      return (
        ...
        (r.uri = function () {
          var t = this.opts.secure ? 'wss' : 'ws',
            n = this.query || {};
          return (
            this.opts.timestampRequests && (n[this.opts.timestampParam] = F()),
  ...
  function Ot(t, n) {
    ...
    if (Array.isArray(t)) for (var i = 0; i < t.length; i++) t[i] = Ot(t[i], n);
    else if ('object' === c(t))
      for (var r in t)
      ...
      return (
        ...
        (o.emit = function (t) {
          ...
          var c =
            ...
            a =
              this.connected &&
              !(null === (r = this.io.engine) || void 0 === r ? void 0 : r.W());
          return (
