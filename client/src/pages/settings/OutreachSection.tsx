 ...
 *
 * Unchanged behaviour — lifted out of SettingsPage when that screen grew tabs
 * for the settings that moved out of the extension.
 */
  ...
  return (
    <Stack gap="xl">
            ...
            (verifyResult.verified ? (
              ...
              >
                ...
                <Text fz={13} mt={6} c="dimmed">
                  An ordinary account password will not work here — it has to be
                  an app password.
                </Text>
              </Alert>
            ))}
      ...
      >
        ...
        />
        <Button mt="md" onClick={() => save.mutate()} loading={save.isPending}>
          Save
        </Button>
      </Section>
